...
form1，ajax浮动显示消息
 */
var json = {"menus":[{"menuid":"M1","icon":"icon-sys","menuname":"销售合同","url":"","auth":"false","menus":[{"menuid":"M1.2","menuname":"合同管理","icon":"icon-sys"

	,"url":"/form/baseManage/swglSet.jsp","auth":"true"}]},{"menuid":"M2","icon":"icon-sys","menuname":"采购管理","url":"","auth":"false","menus":

	[{"menuid":"M2.2","menuname":"采购合同管理" ,"icon":"icon-sys","url":"/form/supManage/cgsqSet.jsp","auth":"true"}]},

	{"menuid":"M3","icon":"icon-sys","menuname":"供应商结算","url":"","auth":"false","menus":

	[{"menuid":"M3.2","menuname":"付款申请表","icon":"icon-sys","url":"/form/baseInfoManage/dfkList.jsp","auth":"true"},

	{"menuid":"M3.1","menuname":"到票确认表","icon":"icon-sys","url":"/form/baseInfoManage/dpqrSet.jsp","auth":"true"}]},{"menuid":"M4","icon":"icon-sys","menuname":"供应商管理","url":"","auth":"false","menus":

	[{"menuid":"M4.1","menuname":"供应商备案表","icon":"icon-sys","url":"/form/supManage/gysba.jsp","auth":"true"},{"menuid":"M4.2","menuname":"合格供方名录"

	,"icon":"icon-sys","url":"/form/baseInfoManage/gysml.jsp","auth":"true"}]},{"menuid":"M5","icon":"icon-sys","menuname":"商务预算","url":"","auth":"false","menus":[{"menuid":"M5.1","menuname":"预算管理","icon":"icon-sys","url":"/form/supManage/swysSet.jsp","auth":"true"}]},{"menuid":"S1","icon":"icon-sys","menuname":"系统管理","url":"","auth":"false","menus":

	[{"menuid":"S1.1.1","menuname":"商务信息设置","icon":"icon-sys","url":"/form/baseInfoManage/market.jsp","auth":"true"}]}]};
...
function InitLeftMenu() {
    ...
    $.each(json.menus, function(i, n) {//遍历菜单json，第一层菜单
		var menulist ='';
		menulist +='<ul>';
		//遍历
        $.each(n.menus, function(j, o) { //遍历第二层菜单
        	if(o.menus == undefined){//判断第二层是否有子菜单
				...
				menulist +='<li  class="3">';
				menulist += '<div class="nav"><a ref="'+o.menuid+'" href="#" rel=".' + o.url + '" ><span class="icon  '+o.icon+'" >&nbsp;</span><span class="nav">' + o.menuname + '</span></a></div><ul>';
				$.each(o.menus, function(p,q) { //遍历第三层菜单
					if(q.menus==undefined){//判断第三层是否有子菜单
		        		menulist += getMenuItem(q,"none","3");//'<li><div><a ref="'+q.menuid+'" href="#" rel=".' + q.url + '" ><span class="icon '+q.icon+'" >&nbsp;</span><span class="nav">' + q.menuname + '</span></a></div></li> ';
					}else{
						menulist +='<li style="display:none" class="levle-3 4">';
						menulist += '<div class="nav"><a ref="'+q.menuid+'" href="#" rel=".' + q.url + '" ><span class="icon '+o.icon+'" >&nbsp;</span><span class="nav">' + q.menuname + '</span></a></div><ul>';
						$.each(q.menus, function(r,s) { //遍历第四层菜单
							menulist += getMenuItem(s,"none","4");
						});
						menulist += '</ul></li>';
